...
class SwipeLayout : FrameLayout {
    ...
    private inner class SwipeDragViewHelper internal constructor(private val parent: ViewGroup) : ViewDragHelper.Callback() {
        ...
        override fun onViewPositionChanged(changedView: View, left: Int, top: Int, dx: Int, dy: Int) {
            ...
            if (mDraggingProxy.dragDirection == SwipeViewLayouter.DragDirection.HORIZONTAL) {

                mDraggingProxy.moveView(changedView, left)

            } else if (mDraggingProxy.dragDirection == SwipeViewLayouter.DragDirection.VERTICAL) {
        ...
        override fun onViewReleased(releasedChild: View, xvel: Float, yvel: Float) {
            ...
            if (mDraggingProxy.dragDirection == SwipeViewLayouter.DragDirection.VERTICAL) {
                throw InvalidParameterException("VerticalSwipeNotImplemented")
            } else if (mDraggingProxy.dragDirection == SwipeViewLayouter.DragDirection.HORIZONTAL) {
                ...
                if (swipeResult.notifyListener != null && mSwipeListener != null) {
        ...
        override fun clampViewPositionVertical(child: View, top: Int, dy: Int): Int {
            return if (swipeState.state == LEFT_OPEN ||
                    swipeState.state == RIGHT_OPEN ||
                    mDraggingProxy.dragDirection == SwipeViewLayouter.DragDirection.HORIZONTAL) {
                0
            } else 0
        ...
        override fun clampViewPositionHorizontal(child: View, left: Int, dx: Int): Int {
            return if (swipeState.state == SwipeState.DragViewState.TOP_OPEN ||
                    swipeState.state == SwipeState.DragViewState.BOTTOM_OPEN ||
                    !mDraggingProxy.canSwipe(mSwipeDirectionDetector, swipeState.state) ||
                    mDraggingProxy.dragDirection == SwipeViewLayouter.DragDirection.VERTICAL) {
                0
    ...
    companion object {
        ...
        val LEFT_DRAG_VIEW = 1
        val RIGHT_DRAG_VIEW = 2
        val TOP_DRAG_VIEW = 3
        val BOTTOM_DRAG_VIEW = 4
        val SURFACE_VIEW = 5
